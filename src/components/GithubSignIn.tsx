...
const GithubSignIn = () => {
  ...
  return (
    <button
      ...
      className="group h-10 md:h-12 px-3 md:px-6 border-2 border-gray-300 transition duration-300 hover:border-[#ff4410] focus:bg-blue-50 active:bg-blue-100 mt-0 mb-4"
    >
