                ...
                <div className="block block-customer-login">
                  ...
                  >
                    ...
                    >
                      ...
                      <button
                        type="submit"
                        className="text-white bg-[#ff4410] hover:bg-[#ff4410] focus:ring-4 focus:outline-none focus:ring-red-300 font-bold text-sm w-full px-5 py-2.5 text-center dark:bg-[#ff4410] dark:hover:bg-red-600 dark:focus:ring-red-800 cursor-pointer uppercase"
                      >
                        Sign up
                      </button>
                    </form>
